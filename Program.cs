...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "Developed by Jaelson Lima - Estudo com base na aula do Eduardo Pires",
        Contact = new OpenApiContact { Name = "Jaelson Lima", Email = "jaelsonlima_93@hotmail.com" },
...
{
    //padrão o map verbo, a rota e o delegate(ação que vai ser feita)
